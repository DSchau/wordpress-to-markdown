...
var a = 'b';
  ...
  test('addjs', async() => {
    const result = await addjsToCodeFence("[addjs src=\"https://gist.github.com/JakePartusch/50737c37e988759e66b6.js?file=angular-controller.js\"\\]");
